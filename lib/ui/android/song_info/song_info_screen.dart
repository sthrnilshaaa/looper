...
import 'package:looper_player/ui/android/widgets/audio_analysis/audio_analysis_widget.dart';
                                  ...
                                  children: [
                                    ...
                                    _buildInfoSection(
                                      ...
                                      items: [
                                        ...
                                        if (analysis?.composer != null &&
                                            analysis!.composer!.isNotEmpty)
                                          _InfoItem(
                                            l10n.composer,
                                            analysis.composer!,
                                          ),
                                        ...
                                        _InfoItem(
                                          l10n.recordLabel,
                                          (analysis?.label == null ||
                                                  analysis!.label!.isEmpty)
                                              ? l10n.notAvailable
                                              : analysis.label!,
                                        ),
                                        _InfoItem(
                                          l10n.copyright,
                                          (analysis?.copyright == null ||
                                                  analysis!.copyright!.isEmpty)
                                              ? l10n.notAvailable
                                              : analysis.copyright!,
                                          isLong: true,
                                        ),
                                    ...
                                    _buildInfoSection(
                                      ...
                                      items: [
                                        ...
                                        _InfoItem(l10n.fileFormat, format),
                                        _InfoItem(
                                          l10n.fileSize,
                                          _formatFileSize(widget.song.path),
                                        ),
                                        _InfoItem(
                                          l10n.dateAdded,
                                          DateFormat.yMMMd(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.song.artist ?? context.l10n.unknownArtist,
                style: AppFonts.jostStyle(color: Colors.white70, fontSize: 16),
              ),
              const SizedBox(height: 4),
              Text(
                widget.song.album ?? context.l10n.unknownAlbum,
                style: AppFonts.jostStyle(
                  color: primaryColor,
                  fontSize: 14,
