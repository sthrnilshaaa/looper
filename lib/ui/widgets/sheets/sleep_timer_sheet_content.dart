...
class SleepTimerSheetContent extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SleepTimerSheetContent> createState() =>
      _SleepTimerSheetContentState();
}

class _SleepTimerSheetContentState
    extends ConsumerState<SleepTimerSheetContent> {
          ...
          children: [
            ...
            Text(
              isSleepTimerActive
                  ? (sleepTimerDurationRemaining != null
                        ? l10n.sleepTimerStoppingIn(
                            formatSleepTimerRemaining(
                              l10n,
                              durationRemaining: sleepTimerDurationRemaining,
                            ),
                          )
                        : l10n.sleepTimerStoppingAfter(
                            formatSleepTimerRemaining(
                              l10n,
              ...
              style: AppFonts.jostStyle(
                fontSize: 14,
                color: isSleepTimerActive ? accentColor : Colors.white54,
              ),
            ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        l10n.minutesShort(_customMinutes),
                        style: AppFonts.jostStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                          color: Colors.white,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 16),
                      Text(
                        l10n.songsCountTitle(_customSongs),
                        style: AppFonts.jostStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                          color: Colors.white,
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _buildCustomChip(
                    label: l10n.songsCountTitle(1),
                    onTap: () => _startSongs(1),
                  ),
                  _buildCustomChip(
                    label: l10n.songsCountTitle(2),
                    onTap: () => _startSongs(2),
                  ),
                  _buildCustomChip(
                    label: l10n.songsCountTitle(3),
                    onTap: () => _startSongs(3),
                  ),
                  _buildCustomChip(
                    label: l10n.songsCountTitle(5),
                    onTap: () => _startSongs(5),
                  ),
                  _buildCustomChip(
                    label: l10n.songsCountTitle(10),
                    onTap: () => _startSongs(10),
                  ),
                ],
              ),
            ),
...
String formatSleepTimerRemaining(
  ...
  if (durationRemaining != null) {
    ...
    return l10n.songsLeft(songsRemaining);
  }
  return '';
}
