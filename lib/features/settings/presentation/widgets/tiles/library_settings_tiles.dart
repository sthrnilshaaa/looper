...
class ExcludedFoldersTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListTile(
      ...
      title: Text(context.l10n.excludedFolders, style: _tileTitleStyle()),
      subtitle: Text(
        excluded.isEmpty
            ? context.l10n.none
            : context.l10n.foldersSkippedCount(excluded.length),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    context.l10n.excludedFoldersDesc,
                    style: _tileSubtitleStyle(),
                  ),
                  ...
                  if (excluded.isEmpty)
                    Padding(
                      ...
                      child: Text(
                        context.l10n.noExcludedFoldersYet,
                        style: _tileSubtitleStyle(),
                      ),
                    )
                  else
                  ...
                  TextButton.icon(
                    onPressed: () async {
                      final path = await FolderPickerHelper.pickFolderPathOnly(
                        sheetContext,
                      );
                      if (path != null) {
                        await ref
                    ...
                    label: Text(context.l10n.excludeAFolder),
                  ),
                ],
              ),
            ),
