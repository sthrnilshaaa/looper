...
import 'package:looper_player/features/library/data/services/artist_image_service.dart';
...
class Library extends _$Library {
  ...
  LibraryState build() {
    ...
    ref.listen<List<String>>(settingsProvider.select((s) => s.libraryFolders), (
      previous,
      next,
    ) async {
